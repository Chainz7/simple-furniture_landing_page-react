...
function FurnitureRight() {
  ...
  return (
    <Container>
      ...
      <Footer>
        <motion.div whileInView={isItemActive[0] ? { opacity: [0.5, 1] } : {}} transition={{ duration: .5, ease: 'easeInOut' }}>
        ...
        <motion.div whileInView={isItemActive[1] ? { opacity: [0.5, 1] } : {}} transition={{ duration: .5, ease: 'easeInOut' }}>
        ...
        <motion.div whileInView={isItemActive[2] ? { opacity: [0.5, 1] } : {}} transition={{ duration: .5, ease: 'easeInOut' }}>
        ...
        <motion.div whileInView={isItemActive[3] ? { opacity: [0.5, 1] } : {}} transition={{ duration: .5, ease: 'easeInOut' }}>
