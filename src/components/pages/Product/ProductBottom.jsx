...
function ProductBottom() {
  ...
  const [isItemActive, setIsItemActive] = useState([true, false, false, false]);
  const options = {
    loop: true,
    margin: 30,
    items: 4,
  ...
  return (
    <Container className="owl-theme" {...options}>
      {/* Item 1 */}
      <SwiperImageBig whileHover={isItemActive ? { scale: 1.1 } : {}} transition={{ duration: 0.5, type: 'tween' }} onClick={() => setIsItemActive([true, false, false, false])}>
      ...
      {/* Item 2 */}
      <SwiperImageBig whileHover={isItemActive ? { scale: 1.1 } : {}} transition={{ duration: 0.5, type: 'tween' }} onClick={() => setIsItemActive([false, true, false, false])}>
      ...
      {/* Item 3 */}
      <SwiperImageBig whileHover={isItemActive ? { scale: 1.1 } : {}} transition={{ duration: 0.5, type: 'tween' }} onClick={() => setIsItemActive([false, false, true, false])}>
      ...
      {/* Item 4 */}
      <SwiperImageBig whileHover={isItemActive ? { scale: 1.1 } : {}} transition={{ duration: 0.5, type: 'tween' }} onClick={() => setIsItemActive([false, false, false, true])}>
